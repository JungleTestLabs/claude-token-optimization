...
flowchart TB
    subgraph INPUT["📥 输入Token (Input) — $3/MTok*"]
        SP["系统提示词 System Prompt\n(每次会话固定 ~20K-30K tokens)<br/>⚠️ 实测比预估大4-6倍"]
...
|----------|:----:|:--------------:|:-----------------:|------|
| 系统提示词 | 20-30% | 20K-30K | 20K-30K | 每次会话固定"起步价"（社区实测） |
| 项目CLAUDE.md | 2-5% | 0.5K-3K | 0.5K-3K | 用户可控，应精简 |
| 文件内容读取 | 30-50% | 10K-50K | 100K-500K+ | **最大消耗源**，可大幅优化 |
| 对话历史 | 15-30% | 10K-50K | 50K-200K+ | 累积增长，需定期compact |
| 工具定义+MCP Server | 5-15% | 5K-15K | 5K-15K | 闲置MCP Server也会消耗 |
